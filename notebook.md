...
- [flutter notes](#day-1)
  - [what is flutter](#notes)
   - key terms and design widgets](#practice)
   - [Code Definitions](#code_definitions)
-[definitions with structures](#markdown-style-guide-for-coding-notebooks)
...
|      | A clickable button that floats above content. You choose what happens when it's clicked. | `ElevatedButton(onPressed: ..., child: ...)` |  |  ||      | The code that gets run when a button is tapped or something happens. | `onPressed: () => doSomething()` |  |  |
